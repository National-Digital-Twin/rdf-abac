...
import static uk.gov.dbt.ndtp.jena.abac.attributes.ValueTerm.FALSE;
import static uk.gov.dbt.ndtp.jena.abac.attributes.ValueTerm.TRUE;
...
class TestAttributeExprEval extends AbstractParser {
