...
import uk.gov.dbt.ndtp.jena.abac.lib.LabelledDataWriter;
...
//    public static void cleanup() {}
    ...
    private static final String DIR_NAME_LABELS_STORE = "target/LabelsStore.db";
    ...
    @Test public void persistent_server_1() {
        ...
        assertDoesNotThrow(() -> {
            noLabelStoreDirectory(DIR_NAME_LABELS_STORE);
    ...
    private void server_restart(String configurationFile) {
        ...
        FileOps.ensureDir(DATABASE_AREA);
        FileOps.clearAll(DATABASE_AREA);
    ...
    private static final String DATABASE_AREA = "target/databases";
    ...
    @Test public void server_all() {
        ...
        try {
            ...
            PlayLib.sendStringHTTP(URL+"/upload", ConstForTestServerABAC.dataWithLabelsTriG);
            Graph g2 = HttpRDF.httpGetGraph(URL+"/labels", null);
    ...
    @Test public void labelled_data_trig_01() {
        ...
        test_dataByTrig(ConstForTestServerABAC.configServer+ ConstForTestServerABAC.configDatasetDftLabelStar, 7, 4, 1);
    }

    @Test public void labelled_data_trig_02() {
        // Without authz:tripleDefaultLabels
        test_dataByTrig(ConstForTestServerABAC.configServer+ ConstForTestServerABAC.configDatasetNoDftLabel, 6, 3, 0);
    }
    ...
    private void test_dataByTrig(String config, int countU1, int countU2, int countU3) {
        ...
        try {
            String URL ="http://localhost:"+server.getPort()+"/ds";
            loadData(server, List.of(ConstForTestServerABAC.dataWithLabelsTriG));
    ...
    @Test public void labelled_data_triples_01() {
        // With authz:tripleDefaultLabels     "*" ;
        test_dataByTriples(ConstForTestServerABAC.configServer+ ConstForTestServerABAC.configDatasetDftLabelStar, 5, 3, 1);
    }

    @Test public void labelled_data_triples_02() {
        // No authz:tripleDefaultLabels -> deny?
        test_dataByTriples(ConstForTestServerABAC.configServer+ ConstForTestServerABAC.configDatasetNoDftLabel, 5, 3, 1);
    }

    @Test public void labelled_data_triples_03() {
        // No authz:tripleDefaultLabels status=confidential
        test_dataByTriples(
            ConstForTestServerABAC.configServer+ ConstForTestServerABAC.configDatasetDfLabelConfidential, 5, 3, 1);
    }
    ...
    private static List<String> dataTriples =
            List.of(
                    ...
                    ConstForTestServerABAC.dataTriplesLabelDeny,
                    ConstForTestServerABAC.dataTriplesLabelEmpty,
                    ConstForTestServerABAC.dataTriplesLabelOpen,

                    ConstForTestServerABAC.payloadTriplesLabelPublic,
                    ConstForTestServerABAC.payloadTriplesLabelConfidential,
                    ConstForTestServerABAC.payloadTriplesLabelSensitive,
                    ConstForTestServerABAC.payloadTriplesLabelPrivate
                    );
    ...
    private void query(WithDebug debug, String url, String user, String queryString, int expectedCount) {
        ...
        ABACTestRunner.debugABAC(withDebug, ()->{
            // == ABAC Query
    ...
    private Graph gspGET(WithDebug debug, String URL, String user, int expectedCount) {
        boolean withDebug = (debug == WithDebug.DEBUG);
        return ABACTestRunner.calcDebugABAC(withDebug, () -> {
